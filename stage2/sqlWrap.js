...
//creates new database object, not a new database
const db = new sql.Database("videos.db");
//once database is created, it will create a file named videos.db
...
function createVideoTable() {
  ...
  const cmd = 'CREATE TABLE IF NOT EXISTS VideoTable (url TEXT, nickname TEXT, userid TEXT, flag INTEGER)';
